function changedList() {
  const inputButton = document.getElementById('perfect-child');
  ...
  const selectElem = document.getElementById('country-child');
  ...
  const selectElemSecond = document.getElementById('service-child');
  for (let i = 0; i < servicesCollection.length; i++) {
    const defaultElem = document.createElement('option');
  ...
  // }
  const seacrhElem = document.getElementById('search-obj');
  seacrhElem.oninput = () => {
    const inputStr = seacrhElem.value;
    const fx = document.getElementById('service-child');
    const servicesLength = fx.children.length;
  ...
  const countryValueElem = document.getElementById('country-child');
